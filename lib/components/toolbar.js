...
var Toolbar = function (_React$Component) {
  ...
  _createClass(Toolbar, [{
    ...
    value: function render() {
      ...
      var isOpen = true;
      if (!editorEnabled || editorState.getSelection().isCollapsed() || (0, _model.isMultiBlockSelection)(editorState)) {
        isOpen = false;
      }
      if (showURLInput) {
        var className = 'guided-editor-toolbar' + (isOpen ? ' guided-editor-toolbar--isopen' : '');
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              { className: 'guided-url-input-close', onClick: this.hideLinkInput },
              '\xD7'
            ),
...
var INLINE_BUTTONS = exports.INLINE_BUTTONS = [{
  label: 'B',
  style: _constants.Inline.BOLD,
  icon: 'bold',
  description: 'Bold'
}, {
  label: 'I',
  style: _constants.Inline.ITALIC,
  icon: 'italic',
  description: 'Italic'
}, {
  label: _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        'g',
        { transform: 'translate(-468.000000, -254.000000)', stroke: '#5c68e0' },
        _react2.default.createElement(
          'g',
  ...
  label: _react2.default.createElement(
    ...
    _react2.default.createElement('path', { d: 'M11 2.95L8.7 1l-.65.75 2.3 1.95.65-.75zM3.95 1.8l-.65-.75L1 2.95l.65.75 2.3-1.9zm2.3 2.3H5.5v3l2.35 1.45.4-.6-2-1.2V4.1zM6 2.1c-2.5 0-4.5 2-4.5 4.5s2 4.5 4.5 4.5 4.5-2 4.5-4.5-2-4.5-4.5-4.5zm0 8c-1.95 0-3.5-1.55-3.5-3.5S4.05 3.1 6 3.1s3.5 1.55 3.5 3.5-1.55 3.5-3.5 3.5z' })
  ),
  style: _constants.Inline.REMINDER,
  icon: 'reminder',
