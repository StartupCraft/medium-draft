...
var GoalBlock = function (_React$Component) {
  _inherits(GoalBlock, _React$Component);

  function GoalBlock(props) {
    _classCallCheck(this, GoalBlock);

    var _this = _possibleConstructorReturn(this, (GoalBlock.__proto__ || Object.getPrototypeOf(GoalBlock)).call(this, props));

    _this.updateData = _this.updateData.bind(_this);
    return _this;
  }

  _createClass(GoalBlock, [{
    key: 'updateData',
